...
RSpec.describe Robots::DorRepo::GisDerivative::StartGisDerivativeWorkflow do
  ...
  describe '#perform' do
    ...
    context 'when object is not open' do
      ...
      it 'raises an error' do
        expect { perform }.to raise_error 'GIS derivative has been started with an object that is not open'
      end
    end
  end
end
