    ...
    describe 'loading a raster dataset' do
      ...
      before do
        ...
        stub_request(:get, 'http://example.com/geoserver/rest/styles/raster.xml')
          .to_return(status: 200, body: '<style><name>raster</name><format>sld</format><languageVersion><version>1.0.0</version></languageVersion><filename>raster.sld</filename></style>') # rubocop:disable Metrics/LineLength
